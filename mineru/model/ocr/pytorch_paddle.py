...
class PytorchPaddleOCR(TextSystem):
    def __init__(self, *args, **kwargs):
        ...
        self.is_vietocr_seq2seq = self.lang == 'vi_vietocr_seq2seq'
        ...
        if self.is_vietocr_seq2seq:
            from mineru.model.ocr.vietocr_seq2seq import VietOCRSeq2SeqRecognizer
            from mineru.model.utils.tools.infer import predict_det

            self.text_detector = predict_det.TextDetector(args, **kwargs)
            self.text_recognizer = VietOCRSeq2SeqRecognizer(device=device)
