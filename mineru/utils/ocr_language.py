...
_PUBLIC_OCR_LANGUAGE_DESCRIPTIONS = {
    "vi": "Vietnamese (VietOCR Seq2Seq + PP-OCRv6 Det)",
    "vi_vietocr_seq2seq": "Vietnamese (VietOCR Seq2Seq + PP-OCRv6 Det)",
...
def normalize_ocr_model_lang(
    ...
    *,
    ...
    if normalized_lang in _CH_LANG_ALIASES:
        normalized_lang = "ch"
    elif normalized_lang == "vi":
        normalized_lang = "vi_vietocr_seq2seq"
